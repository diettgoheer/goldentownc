...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "goldentown2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "goldentown2 API";

        private String description = "goldentown2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "goldentown2";
