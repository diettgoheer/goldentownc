...
/**
 * Performance test for the World entity.
 */
class WorldGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the World entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created world")
                .get("${new_world_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created world")
            .delete("${new_world_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
